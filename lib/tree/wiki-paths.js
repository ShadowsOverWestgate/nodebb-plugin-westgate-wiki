...
async function getCanonicalNamespaceInfo(category, options = {}) {
  ...
  return wikiShapes.assertShape(
    await wikiTreeIndex.getCanonicalNamespacePathInfo(category, options),
    wikiShapes.PATH_INFO_KEYS,
    "getCanonicalNamespaceInfo result"
  );
}
...
function getCacheMetrics() {
  return wikiTreeIndex && typeof wikiTreeIndex.getCacheMetrics === "function" ?
    wikiTreeIndex.getCacheMetrics() :
    {};
}
